...
public:
    ...
    void clear();
    void setColor(int x, int y, arc::Color color);
    void renderLine(int x, int y, const arc::Color& color, RotationDir direction);
    void renderLine(int x, int y, int len, const arc::Color& color, RotationDir direction);
...
private:
    ...
    const int m_width;
    const int m_height;
    const arc::Color& m_defaultBgColor;
    std::vector<arc::Color> m_colors;
};
